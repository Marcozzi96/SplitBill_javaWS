...
import it.javaWS.javaws.models.dto.GroupDTO;
...
public class GroupController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Utenti aggiunti al gruppo"),
        @ApiResponse(responseCode = "401", description = "Accesso non autorizzato")
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Utente rimosso dal gruppo"),
        @ApiResponse(responseCode = "400", description = "Gruppo non trovato"),
        @ApiResponse(responseCode = "401", description = "Accesso non autorizzato")
    })
    @DeleteMapping("/leave/{groupId}")
    public ResponseEntity<?> leaveTheGroup(
            @PathVariable Long groupId) {
